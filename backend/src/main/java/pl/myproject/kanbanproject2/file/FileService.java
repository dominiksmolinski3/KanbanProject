...
public class FileService {
    ...
    /**
     * A file belongs to whoever uploaded it, and to nobody else. Ids are small sequential integers,
     * so before there was an owner column to check, {@code GET /api/files/1..n} read every upload in
     * the deployment and {@code DELETE} destroyed them. A row with no owner is treated as belonging
