...
variable "extra_cors_origins" {
  description = "Additional browser origins allowed to call this API, beyond the app's own generated Container Apps URL (which is always included automatically). Set this to a production custom domain, e.g. [\"https://kanbanproject.pl\", \"https://www.kanbanproject.pl\"]."
  type        = list(string)
  default     = []
}
